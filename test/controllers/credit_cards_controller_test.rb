...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post credit_cards_url, params: { credit_card: { cvc: @credit_card.cvc, digits: @credit_card.digits, month: @credit_card.month, number: @credit_card.number, year: @credit_card.year } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { cvc: @credit_card.cvc, digits: @credit_card.digits, month: @credit_card.month, number: @credit_card.number, year: @credit_card.year } }
